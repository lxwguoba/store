...
import com.zerone.intodata.domain.ProgressBarBean;
...
//        M_mUpLoad.do file_fileUpload.do
     ...
     * @param params 参数的封装
     */
    public static void xuploadPro(Activity activity, RequestParams params, final Handler handler, final int responseID) {

        if (CheckNetWorkUtils.isNetworkAvailable(activity)) {
            ...
            message.obj = "";
            handler.sendMessage(message);
            CheckNetWorkUtils.setNetworkMethod(activity);
        }
    }
}
