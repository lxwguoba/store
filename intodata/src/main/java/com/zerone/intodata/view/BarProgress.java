package com.zerone.intodata.view;
...
public class BarProgress extends ProgressBar {

    private static final String TAG = BarProgress.class.getSimpleName();
    ...
    public BarProgress(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mTextSize = BarProgress.sp2px(context, 10);
        mTextMargin = BarProgress.dp2px(context, 4);
        mReachedColor = Color.parseColor("#70A800");
        mReachedHeight = BarProgress.dp2px(context, 2);
        mUnReachedColor = Color.parseColor("#CCCCCC");
        mUnReachedHeight = BarProgress.dp2px(context, 1);
        mIsCapRounded = false;
        mIsHiddenText = false;

        mRadius = BarProgress.dp2px(context, 16);
    }
