...
import zerone.myapplication.adapter.CustomerAdapter;
import zerone.myapplication.adapter.fragment.log.DealLogAdapter;
...
public class DealLogFragment extends Fragment  {
    private View view;
    private RecyclerView recyclerView;
    private DealLogAdapter recycleAdapter;
                ...
                case 1:
                    try {
                        ...
                        if (statu == 1) {
                            ...
                            Gson gson = new Gson();
                            List<DoOperationBean> ps = gson.fromJson(li, new TypeToken<List<DoOperationBean>>() {
                            }.getType());
                            if (ps.size() > 0) {
    ...
    private void initRecycleView(View view) {
        ...
        //设置Adapter
        recycleAdapter = new DealLogAdapter(mData,getActivity());
    ...
    public void getLoginLogData() {
        ...
        parmar.put("page", "1");
        NetUtils.netWorkByMethodPost(getContext(), parmar, IPConfig.OPERATION_LOG, handler, 1);
    }
    ...
    public void moreLoginLogData() {
        ...
        NetUtils.netWorkByMethodPost(getContext(), parmar, IPConfig.OPERATION_LOG, handler, 2);
    }
