...
public class GuoBaProgressBar extends View implements Runnable{
    ...
    public GuoBaProgressBar(Context context) {
        this(context, null, 0);
    }

    public GuoBaProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GuoBaProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(attrs);
    }

    private void initAttrs(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.GuoBaProgressBar);
        try {
            textSize = (int) ta.getDimension(R.styleable.GuoBaProgressBar_textSize, 12);
            loadingColor = ta.getColor(R.styleable.GuoBaProgressBar_loadingColor, Color.parseColor("#40c4ff"));
            stopColor = ta.getColor(R.styleable.GuoBaProgressBar_stopColor, Color.parseColor("#ff9800"));
            radius = (int) ta.getDimension(R.styleable.GuoBaProgressBar_radius, 0);
            borderWidth = (int) ta.getDimension(R.styleable.GuoBaProgressBar_borderWidth, 1);
        } finally {
            ta.recycle();
        }
    }
